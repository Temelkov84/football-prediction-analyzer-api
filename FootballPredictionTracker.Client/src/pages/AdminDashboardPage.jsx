...
import ImportPredictionsForm from '../components/admin/ImportPredictionsForm'
        ...
        <main className="page">
            ...
            <section className="card">
                ...
                <div className="admin-actions">
                    ...
                    <button
                        type="button"
                        className={activeAdminSection === 'import-predictions' ? 'active' : ''}
                        onClick={() => setActiveAdminSection('import-predictions')}
                    >
                        Import Predictions
                    </button>
                </div>
            ...
            {activeAdminSection === 'import-predictions' && (
                <section className="card admin-section">
                    <ImportPredictionsForm />
                </section>
            )}
        </main>
    )
